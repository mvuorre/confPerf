...
math <- read_csv("data/merged.csv", guess_max = 25000)
...
trivia <- read_rds("data/exp-trivia.rds") %>% 
  mutate(condition = factor(condition, levels = c("free", "mafc"), labels = c("Free", "2AFC")))
